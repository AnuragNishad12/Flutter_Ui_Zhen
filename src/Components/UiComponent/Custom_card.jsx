...
import {custom_Card} from '../../Codes/Codes'

function Custom_card() {
    const [copied, setCopied] = useState(false); 

    const copyToClipboard = () => {
      copy(custom_Card); // Copy alertBox instead of code
      setCopied(true); 
  ...
  return (
    <div className='alert'>
      ...
      <img className='FullCodeGB' src='https://firebasestorage.googleapis.com/v0/b/gokqmp.appspot.com/o/images%2FScreenshot%202024-06-21%20164431.png?alt=media&token=08134798-69c3-4304-a1c5-62848654df3f' alt=''/>
      <div className="code-snippet-container">
        <div className="code-box">
          <pre>
            <code>{custom_Card}</code>
          </pre>
        </div>
      ...
      <h4>Result</h4>
      <img height={600} width={600} class="rounded-image"  src='https://firebasestorage.googleapis.com/v0/b/gokqmp.appspot.com/o/images%2FWhatsApp%20Image%202024-06-21%20at%2016.45.27.jpeg?alt=media&token=089d6bf8-4cad-4544-a25f-90d02bd1879b' alt=''/>  
    </div>
  )
}
