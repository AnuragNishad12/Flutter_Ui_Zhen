...
import {Custom_progress} from '../../Codes/Codes'
import video from '../../Videos/circular_progress.mp4'


function Custom_Progress_indicator() {
  
    const [copied, setCopied] = useState(false); 

    const copyToClipboard = () => {
      copy(Custom_progress); // Copy alertBox instead of code
      setCopied(true); 
  ...
  return (
    <div className='alert'>
    <h1>How to Use : Cutom Circular Progress Bar</h1>
    ...
    <img className='FullCodeGB' class="rounded-image" src='https://firebasestorage.googleapis.com/v0/b/gokqmp.appspot.com/o/images%2FScreenshot%202024-06-29%20165214.png?alt=media&token=70930413-afb0-4d83-9feb-8dc4adea9e33' alt=''/>
    <div className="code-snippet-container">
      <div className="code-box">
        <pre>
          <code>{Custom_progress}</code>
        </pre>
      </div>
    ...
    <h4>Result</h4>
    {/* <img height={260} width={400}  class="rounded-image" src='https://firebasestorage.googleapis.com/v0/b/gokqmp.appspot.com/o/images%2FWhatsApp%20Image%202024-06-29%20at%2016.49.29.jpeg?alt=media&token=50b628d0-9d1b-42d6-83a5-11875e387b62' alt=''/>   */}
    <video width="400px"  class="rounded-image" autoPlay 
      loop 
...
export default Custom_Progress_indicator
